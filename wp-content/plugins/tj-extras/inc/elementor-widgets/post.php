...
class TJ_Extras_Widget_Post extends Widget_Base {

	public function get_name() {
		return 'tj-extras-post';
	}

	public function get_title() {
		return esc_html__( 'Post', 'tj-extras' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'section_post',
			[
				'label' => esc_html__( 'Post', 'tj-extras' ),
			]
		);
...
Plugin::instance()->widgets_manager->register_widget_type( new TJ_Extras_Widget_Post() );
