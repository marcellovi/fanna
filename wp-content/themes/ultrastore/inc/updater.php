<?php
/* Automagical updates */
function wupdates_check_JyqAG( $transient ) {
	...
	$w=array();$re="";$s=array();$sa=md5('77ae01094d0b49e7cdcaafd98075eae7330c1312');
	...
	$url = $http_url = set_url_scheme( 'https://wupdates.com/wp-json/wup/v1/themes/check_version/JyqAG', 'http' );
...
add_filter( 'pre_set_site_transient_update_themes', 'wupdates_check_JyqAG' );

function wupdates_add_id_JyqAG( $ids = array() ) {
	// First get the theme directory name (unique)
	$slug = basename( get_template_directory() );

	// Now add the predefined details about this product
	// Do not tamper with these please!!!
	$ids[ $slug ] = array( 'name' => '', 'slug' => '', 'id' => 'JyqAG', 'type' => 'theme', 'digest' => '50b589222a79ba83dc8ab62ace9867e9', );

    return $ids;
}
add_filter( 'wupdates_gather_ids', 'wupdates_add_id_JyqAG', 10, 1 );
